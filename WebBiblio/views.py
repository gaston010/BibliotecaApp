...
from .forms import EmpleadoForm, AutoresForm, SociosForm, LibroForm, PrestamoLibroForm
from .models import Empleado, Socio, Libro, PrestamoLibro, Autor
...
def actualizar_empleado(request, id):
    ...
    if request.method == "POST":
        ...
        if request.POST.get("activo") is None:
...
def borrar_empleado(request, id):
    ...
    return render(request, "empleado_borrar.html",
                  {"empleado": empleado, "socios": socios, "libros": libros, "prestamos": prestamos,
                   "empleados": empleados, "e": e})
...
def borrar_autor(request, id):
    ...
    return render(request, "autor_borrar.html",
                  {"autor": autor, "libros": libros, "prestamos": prestamos, "socios": socios, "empleados": empleados})
...
def borrar_socio(request, id):
    ...
    return render(request, "socio_borrar.html",
                  {"socio": socio, "empleados": empleados, "libros": libros, "prestamos": prestamos})
...
def actualizar_prestamo(request, id):
    ...
    prestamo_viejo = PrestamoLibro.objects.get(id=id)
    ...
    if request.method == "POST":
        ...
        # REEMPLAZAR CON EL NOMBRE DEL TEMPLATE QUE SE USARÁ
        return render(request, "prestamo_actualizar.html",
                      {"prestamo": prestamo, "socios": socio, "socio_actual": socio_actual, "empleados": empleado,
                       "empleado_actual": empleado_actual, "libros": libro, "libro_actual": libro_actual})
...
def borrar_prestamo_libro(request, id):
    ...
    return render(request, "prestamo_borrar.html",
                  {"prestamo": prestamo, "libro_actual": libro_actual, "socio_actual": socio_actual,
