...
from WebBiblio.views import *
from exportcsv.views import autores_a_csv, libros_a_csv, empleado_a_csv, socio_a_csv, prestamo_a_csv, historial
...
] + url_emp + url_aut + url_soc + url_lib + url_pres + ulr_export
